...
public class Main {
    public static void main(String[] args) {
        ...
        order.setPaymentAdapter(new StripeAdapter(new StripeGateway()));
        //PaymentGateway paymentGateway = new StripeAdapter(new StripeGateway());

        // Process a payment
        boolean paymentSuccessful = order.processPayment(order.getTotalPrice(), "1234567890123456", "12/25", "123");
